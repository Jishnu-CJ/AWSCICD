...
The basic idea behind the project, once the developer did the code changes and pushed to the Code commit it will build the corresponding Docker image and store the artifacts into the S3 and also pushed the image to the ECR that we have used for our container registry.
